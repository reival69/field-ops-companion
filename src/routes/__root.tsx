...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Operario" },
      { title: "Panel del Operario — órdenes de trabajo en campo" },
      {
        name: "description",
        content:
          "App de campo para operarios de mantenimiento: órdenes asignadas, estados, fotos antes/después y navegación al cliente.",
      },
